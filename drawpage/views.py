        ...
        # If clustering_method_select and event_assignment_select
            ...
            if 'file_cookie' in request.session:
                ...
                if 'file_cookie' in request.session and 'object_type_cookie' in request.session and 'clustering_method_cookie' in request.session:
                    ...
                    dfg_file_path_list = main.main_draw(path_to_file, object_information, request.session['object_type_cookie'], request.session['clustering_method_cookie'], selected_event_assignment)
