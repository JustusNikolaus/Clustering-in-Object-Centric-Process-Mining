...
var _timeButton = _interopRequireDefault(require("./timeButton"));
...
function () {
  function ControllerBtn(cfg) {
    this.controllerCfg = (0, _util.deepMix)({}, DEFAULT_CONTROLLER_CONFIG, cfg);
  ...
  ControllerBtn.prototype.renderPlayButton = function () {
    ...
    if (this.playButton) {
      ...
      this.playButton = new _timeButton.default({
  ...
  ControllerBtn.prototype.bindEvent = function () {
    ...
    this.speedGroup.on('speed-rect:click', function (evt) {
      ...
      _this.group.emit(_constant.TIMEBAR_CONFIG_CHANGE, {
