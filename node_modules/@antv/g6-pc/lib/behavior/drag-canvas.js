...
var cloneEvent = _util.default.cloneEvent,
    isNaN = _util.default.isNaN;
var abs = Math.abs;
var DRAG_OFFSET = 10;
...
var _default = {
  ...
  onMouseDown: function onMouseDown(e) {
    ...
    if (event && e.name !== _g6Core.G6Event.TOUCHSTART && event.button !== 0) {
      return;
    }

    if (e.name !== _g6Core.G6Event.TOUCHSTART && typeof window !== 'undefined' && window.event && !window.event.buttons && !window.event.button) {
      return;
    }
