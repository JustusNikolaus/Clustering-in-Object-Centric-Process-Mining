...
var _default = {
  ...
  onClick: function onClick(ev) {
    ...
    if (self.addingEdge && self.edge) {
      ...
      if (getEdgeConfig && (0, _util.isFunction)(getEdgeConfig)) {
      ...
      var updateCfg = (0, _tslib.__assign)({
        target: model.id
      }, edgeConfig);
      ...
      if (graph.get('enabledStack')) {
        var addedModel = (0, _tslib.__assign)((0, _tslib.__assign)({}, self.edge.getModel()), {
          itemType: 'edge'
        });
        var after = {};
      ...
      self.edge = graph.addItem('edge', (0, _tslib.__assign)({
        source: model.id,
        target: model.id
      }, edgeConfig), false);
