...
import { IBBox, IShapeBase, ModelConfig, ShapeStyle, NodeConfig, EdgeConfig, ComboConfig, ITEM_TYPE, UpdateType } from '../types';
export default class ItemBase implements IItemBase {
     ...
     */
    updatePosition(cfg: ModelConfig): boolean;
    /**
